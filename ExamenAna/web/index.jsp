<%-- 
    Document   : indez
    Created on : 20/10/2018, 09:51:32 AM
    Author     : Ana González
--%>
            ...
            <aside id="colorlib-aside" role="complementary" class="border js-fullheight">
                ...
                <nav id="colorlib-main-menu" role="navigation">
                    <ul>
                        ...
                        <li><a href="jsp/registro.jsp">Registros</a></li>
                        <li><a href="jsp/consulta.jsp">Consulta</a></li>
                                        ...
                                        <div class="col-md-6 col-md-offset-3 col-md-push-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                                            <div class="slider-text-inner">
                                                <div class="desc">
                                                    ...
                                                    <h2> Made by Ana Marlene González Ángeles</h2>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-md-6 col-md-offset-3 col-md-push-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                                            <div class="slider-text-inner">
                                                <div class="desc">
                                                    <h1>Profesor Emmanuel Oropeza</h1>
                                                    <h2>Made by Ana Marlene González Ángeles</h2>
                                                    <p><a class="btn btn-primary btn-learn">View Project <i class="icon-arrow-right3"></i></a></p>
                                                </div>
                                            </div>
